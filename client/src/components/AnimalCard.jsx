  ...
  return (
    ...
    >
      ...
      <div className="relative pt-[75%] overflow-hidden">
        ...
        {/* Badge on image - top left - Only shows on hover */}
        {isHovered && (
          <div className="absolute top-3 left-3 transition-opacity duration-300">
            <GetBadge type={animal.type.charAt(0).toUpperCase() + animal.type.slice(1)} />
          </div>
        )}

        {/* Scientific name overlay on hover - bottom left */}
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* Subtle footer with action buttons */}

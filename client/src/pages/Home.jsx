      ...
      <>
        ...
        <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
          ...
          <section id='home' className='container mx-auto px-6 py-32 md:py-40 text-center'>
            ...
            <div className="absolute bottom-1/4 right-10 w-24 h-24 bg-green-100 rounded-full filter blur-xl opacity-70 dark:bg-green-900 dark:opacity-30 animate-float-delay"></div>
            
            {/* Tagline */}
            <p className="text-lg md:text-xl font-medium text-blue-600 dark:text-blue-400 mb-4 animate-fade-in">
              Discover the Future of Wildlife
            </p>
            
            {/* Main Heading */}
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-800 dark:text-white mb-6 leading-tight animate-fade-in-up">
              Where Nature Meets<br className="hidden md:block" /> 
              <span className="relative">
                Digital Innovation
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-green-400"></span>
              </span>
            </h1>
            
            {/* Subheading */}
            <h3 className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-10 animate-fade-in-up delay-100">
  ...
  <div className="absolute -top-32 -left-32 w-64 h-64 bg-blue-100 rounded-full filter blur-3xl opacity-30 dark:bg-blue-900 dark:opacity-20"></div>
